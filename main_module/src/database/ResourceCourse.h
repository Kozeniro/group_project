...
public:
    ...
    void update_info(int course_id, const std::string& name, const std::string& description);
    std::vector<TestLine> get_tests(int course_id);
    bool is_test_active(int course_id, int test_id);
    void set_test_active(int course_id, int test_id, bool active);
    int add_test(int course_id, const std::string& test_name);
    void remove_test(int course_id, int test_id);
    std::vector<int> get_students(int course_id);
    void add_user(int user_id, int course_id);
    void remove_user(int user_id, int course_id);
